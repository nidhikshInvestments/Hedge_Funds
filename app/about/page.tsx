              ...
              <div className="group relative p-8 md:p-12 rounded-3xl bg-gradient-to-b from-card/80 to-card/40 backdrop-blur-xl border-2 border-primary/20 hover:border-primary/40 transition-all hover:shadow-[0_0_40px_rgba(245,158,11,0.2)]">
                ...
                <div className="relative flex flex-col md:flex-row gap-8 items-start">
                  <div className="w-full md:w-1/3 flex flex-col items-center text-center shrink-0">
                    ...
                    <p className="text-xl text-primary/90 font-semibold mb-2">Founder & CEO</p>
              ...
              <div className="group relative p-8 md:p-12 rounded-3xl bg-gradient-to-b from-card/80 to-card/40 backdrop-blur-xl border-2 border-primary/20 hover:border-primary/40 transition-all hover:shadow-[0_0_40px_rgba(245,158,11,0.2)]">
                ...
                <div className="relative flex flex-col md:flex-row gap-8 items-start">
                  <div className="w-full md:w-1/3 flex flex-col items-center text-center shrink-0">
                    ...
                    <p className="text-xl text-primary/90 font-semibold mb-2">Director, Investor Relations<br/>& Capital Development</p>
                    <div className="w-16 h-1 bg-gradient-to-r from-primary to-accent rounded-full mb-6" />
                  </div>
              ...
              <div className="group relative p-8 md:p-12 rounded-3xl bg-gradient-to-b from-card/80 to-card/40 backdrop-blur-xl border-2 border-primary/20 hover:border-primary/40 transition-all hover:shadow-[0_0_40px_rgba(245,158,11,0.2)]">
                ...
                <div className="relative flex flex-col md:flex-row gap-8 items-start">
                  <div className="w-full md:w-1/3 flex flex-col items-center text-center shrink-0">
                    ...
                    <p className="text-xl text-primary/90 font-semibold mb-2">Strategic Advisor</p>
                    <div className="w-16 h-1 bg-gradient-to-r from-primary to-accent rounded-full mb-6" />
                  </div>

                  <div className="text-lg font-medium text-muted-foreground leading-relaxed w-full space-y-4 text-left">
                    <p>
                      David Koch is a seasoned International Investment Banker, with more than <strong className="text-white">25 years of experience</strong>, bringing deep strategic insight to Nidhiksh Investments Inc.
                    </p>
                    <p>
