        ...
        <section className="py-12 md:py-20 relative z-10">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-3 gap-8 items-stretch max-w-7xl mx-auto">
              ...
              <div className="group relative p-8 md:p-10 rounded-3xl bg-gradient-to-b from-card/80 to-card/40 backdrop-blur-xl border-2 border-primary/20 hover:border-primary/50 transition-all hover:shadow-[0_0_40px_rgba(245,158,11,0.15)] flex flex-col h-full justify-between">
                ...
                <div className="relative space-y-8">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 bg-primary/10 rounded-2xl flex items-center justify-center border border-primary/30 shadow-[0_0_15px_rgba(245,158,11,0.1)]">
                      <TrendingUp className="h-7 w-7 text-primary" />
                    </div>
                    <h2 className="text-3xl font-extrabold text-white tracking-tight">Public Market</h2>
                  </div>

                  {/* Mandate Statement */}
                  <div className="p-5 rounded-xl bg-primary/5 border border-primary/10 text-base italic text-amber-200/90 leading-relaxed">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-primary">Universe of Leaders</h3>
                  ...
                  <div className="space-y-3 pt-3 border-t border-white/5">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-primary">Investment Framework</h3>
                ...
                <div className="relative pt-6 mt-8 border-t border-white/10 text-sm text-slate-400">
              ...
              <div className="group relative p-8 md:p-10 rounded-3xl bg-gradient-to-b from-card/80 to-card/40 backdrop-blur-xl border-2 border-primary/20 hover:border-primary/50 transition-all hover:shadow-[0_0_40px_rgba(245,158,11,0.15)] flex flex-col h-full justify-between">
                ...
                <div className="relative space-y-8">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-3xl font-extrabold text-white tracking-tight">Commercial Real Estate</h2>
                  </div>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-primary">Core CRE Principles</h3>
                    <ul className="space-y-4.5 text-base text-slate-300">
                      <li className="space-y-1">
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="h-5 w-5 text-primary shrink-0" />
                          <span className="font-semibold text-white">Quality First</span>
                        </div>
                        <p className="pl-7 text-sm text-slate-400 leading-relaxed">
                  ...
                  {/* Acquisition Focus */}
                  <div className="space-y-3 pt-3 border-t border-white/5">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-primary">Acquisition Focus</h3>
                    <p className="text-base text-slate-300 leading-relaxed">
              ...
              <div className="group relative p-8 md:p-10 rounded-3xl bg-gradient-to-b from-card/80 to-card/40 backdrop-blur-xl border-2 border-primary/20 hover:border-primary/50 transition-all hover:shadow-[0_0_40px_rgba(245,158,11,0.15)] flex flex-col h-full justify-between">
                ...
                <div className="relative space-y-8">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-3xl font-extrabold text-white tracking-tight">Private Ventures</h2>
                  </div>
                  ...
                  <div className="space-y-3">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-primary">Venture Mandate</h3>
                    <p className="text-base text-slate-300 leading-relaxed">
                  ...
                  <div className="space-y-3 pt-3 border-t border-white/5">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-primary">Operational Execution</h3>
                    <p className="text-base text-slate-300 leading-relaxed">
                  ...
                  {/* Operating Structure */}
                  <div className="space-y-3 pt-3 border-t border-white/5">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-primary">Operating Structure</h3>
                    <p className="text-base text-slate-300 leading-relaxed">
                ...
                {/* Platform Vision Footer */}
                <div className="relative pt-6 mt-8 border-t border-white/10 text-sm text-slate-400">
                  <span className="text-primary font-semibold">Philosophy:</span> Grounded in ethics, integrity, and stewardship to scale private businesses driven by purpose.
                </div>
              </div>
