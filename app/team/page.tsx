              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto bg-gradient-to-b from-zinc-950 to-background border-primary/20 shadow-2xl">
                    ...
                    <div className="text-base text-muted-foreground leading-relaxed space-y-4">
                      <p>
                        David Koch is a seasoned International Investment Banker, with more than 25 years of experience, bringing deep strategic insight to Nidhiksh Investments Inc.
                      </p>
                      <p>
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto bg-gradient-to-b from-zinc-950 to-background border-primary/20 shadow-2xl">
                    ...
                    <div className="text-base text-muted-foreground leading-relaxed space-y-4">
                      <p>
                        With more than two decades of professional experience, Vince Porter is a CPA and a distinguished member of both the American Institute of Certified Public Accountants and the Texas Society of CPAs. He brings deep technical expertise and disciplined financial stewardship to Nidhiksh Investments Inc., supporting the firm's commitment to maintaining clean, accurate, and compliant financials.
                      </p>
                      <p>
                        Vince is the second-generation leader of Porter & Company CPAs, a firm built on family values, integrity, and forward-thinking advisory practices. Under his leadership, the firm has expanded its capabilities to deliver high-touch guidance to high-net-worth entrepreneurs, real estate investors, and multigenerational family businesses navigating complex financial transitions.
                      </p>
                      <p>
                        Recognized as a Top 40 Under 40 CPA by CPA Practice Advisor, Vince has also been featured by CNN Money, UpJourney, the Fort Worth Star-Telegram, the Grow Your Firm Podcast, and other respected media outlets for his insights on accounting, business strategy, and financial leadership.
                      </p>
                    </div>
                  </DialogContent>
                </Dialog>
